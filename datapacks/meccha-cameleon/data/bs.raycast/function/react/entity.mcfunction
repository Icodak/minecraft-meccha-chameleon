...
execute store result score #z bs.ctx run data get storage bs:data raycast.re[-1].z
...
scoreboard players operation $raycast.entry_point.x bs.lambda -= #x bs.ctx
scoreboard players operation $raycast.entry_point.y bs.lambda -= #y bs.ctx
scoreboard players operation $raycast.entry_point.z bs.lambda -= #z bs.ctx
scoreboard players operation $raycast.exit_point.x bs.lambda -= #x bs.ctx
scoreboard players operation $raycast.exit_point.y bs.lambda -= #y bs.ctx
scoreboard players operation $raycast.exit_point.z bs.lambda -= #z bs.ctx
