...
execute if predicate {condition:"inverted",term:{condition:"any_of",terms:[{condition:"value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.1"},score:"bs.in"},range:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out","scale":-1},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"}}},{condition:"value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.1"},score:"bs.in"},range:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out","scale":-1}}}]}} run scoreboard players operation $vector.normalize_max_component.factor bs.out = $vector.normalize_max_component.1 bs.in
execute if predicate {condition:"inverted",term:{condition:"any_of",terms:[{condition:"value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.2"},score:"bs.in"},range:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out","scale":-1},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"}}},{condition:"value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.2"},score:"bs.in"},range:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out","scale":-1}}}]}} run scoreboard players operation $vector.normalize_max_component.factor bs.out = $vector.normalize_max_component.2 bs.in
