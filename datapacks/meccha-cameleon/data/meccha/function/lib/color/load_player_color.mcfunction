...
# Load this player's chosen hex color from meccha:players.color.<uuid-key>.
# Falls back to the shared last_sample color when that player has not picked one yet.
