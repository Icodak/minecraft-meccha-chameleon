...
$say "Loading colour for $(uuid_key)"
...
$execute unless data storage meccha:players color."$(uuid_key)" run data modify storage meccha:rt brush.color set value "#FFFFFF"
