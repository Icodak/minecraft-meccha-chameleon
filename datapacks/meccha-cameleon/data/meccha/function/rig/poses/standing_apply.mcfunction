...
$function meccha:rig/apply_pose {cuboid:"head", dx:-0.125,  dy:0.75,  dz:0.0, yaw:0, pitch:0, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"torso",dx:-0.125,  dy:0.375, dz:0.0, yaw:0, pitch:0, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"arm_l",dx:0.375, dy:0.375, dz:0.125, yaw:-90, pitch:-45, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"arm_r",dx:-0.375,dy:0.375, dz:0.0, yaw:90, pitch:-45, rid:$(rid)}
