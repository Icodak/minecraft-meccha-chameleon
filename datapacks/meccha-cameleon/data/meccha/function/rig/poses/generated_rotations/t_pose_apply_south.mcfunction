# meccha:rig/poses/t_pose_apply_south   (macro: $(rid); positioned at the rig root)
...
$function meccha:rig/apply_pose {cuboid:"leg_l", dx:0.01, dy:0, dz:-0.015, yaw:0, pitch:0, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"leg_r", dx:-0.135, dy:0, dz:-0.015, yaw:0, pitch:0, rid:$(rid)}
