# meccha:rig/poses/superhero_landing_apply_west   (macro: $(rid); positioned at the rig root)
...
$function meccha:rig/apply_pose {cuboid:"arm_l", dx:-0.1, dy:0, dz:0.3, yaw:170, pitch:0, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"arm_r", dx:-0.1, dy:0.3, dz:-0.1, yaw:60, pitch:-60, rid:$(rid)}
