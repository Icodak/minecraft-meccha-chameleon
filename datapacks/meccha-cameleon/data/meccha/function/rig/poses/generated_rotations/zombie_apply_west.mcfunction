# meccha:rig/poses/zombie_apply_west   (macro: $(rid); positioned at the rig root)
# The file in /pose is the source of truth for the pose, call generate_rotations.bat/.sh to regenerate the rotated versions
$function meccha:rig/apply_pose {cuboid:"head", dx:0.015, dy:0.75, dz:-0.125, yaw:85, pitch:7, rid:$(rid)}
