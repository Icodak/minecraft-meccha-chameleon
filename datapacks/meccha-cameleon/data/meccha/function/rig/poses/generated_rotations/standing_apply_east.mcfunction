# meccha:rig/poses/standing_apply_east   (macro: $(rid); positioned at the rig root)
...
$function meccha:rig/apply_pose {cuboid:"arm_l", dx:0, dy:0.375, dz:-0.125, yaw:-90, pitch:0, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"arm_r", dx:0, dy:0.375, dz:0.25, yaw:-90, pitch:0, rid:$(rid)}
