# meccha:rig/poses/sneaking_apply_west   (macro: $(rid); positioned at the rig root)
...
$function meccha:rig/apply_pose {cuboid:"arm_l", dx:0.2, dy:0.375, dz:0.175, yaw:105, pitch:30, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"arm_r", dx:0.2, dy:0.375, dz:-0.3, yaw:75, pitch:30, rid:$(rid)}
