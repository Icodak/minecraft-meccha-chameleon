# meccha:rig/poses/zombie_apply   (macro: $(rid); positioned at the rig root)
...
$function meccha:rig/apply_pose {cuboid:"arm_l",dx:0.125, dy:0.725, dz:0.0, yaw:0, pitch:90, rid:$(rid)}
$function meccha:rig/apply_pose {cuboid:"arm_r",dx:-0.25,dy:0.725, dz:0.0, yaw:0, pitch:90, rid:$(rid)}
