# meccha:color_picker/apply_adj   (executed AS the clicking player)
...
execute if score #ADJ meccha.tmp matches 1 run function meccha:color_picker/adj_brighter
execute if score #ADJ meccha.tmp matches 2 run function meccha:color_picker/adj_darker
execute if score #ADJ meccha.tmp matches 3 run function meccha:color_picker/adj_sat_up
execute if score #ADJ meccha.tmp matches 4 run function meccha:color_picker/adj_sat_down
