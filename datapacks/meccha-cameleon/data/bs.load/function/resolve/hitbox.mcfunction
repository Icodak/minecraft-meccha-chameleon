...
execute unless score #bs.hitbox.major_versions load.status matches 2.. if score $bs.hitbox.major load.status matches 4 if score $bs.hitbox.minor load.status matches 1 if score $bs.hitbox.patch load.status matches 0 run return 1
